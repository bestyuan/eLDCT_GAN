...
def generator(input):
    ...
    # res3, res3_weights = residual_layer(res1, 3, 128, 128, 1, "g_res3")
    ...
    # deconv1,deconv1_weights = conv_layer(res3,3,128,64,1, 'g_deconv1')
    # deconv2,deconv2_weights = conv_layer(deconv1,3,64,32,1, "g_deconv2")
